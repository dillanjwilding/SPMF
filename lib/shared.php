<?php 
    ...
    function __autoload($className)
    {
        ...
        {
            require_once(ROOT . DS . 'lib' . DS . 'classes' . DS . strtolower($className) . '.php');
        }
        else if(file_exists(ROOT . DS . 'lib' . DS . 'classes' . DS . 'abstract' . DS . strtolower($className) . '.php'))
        {
            require_once(ROOT . DS . 'lib' . DS . 'classes' . DS . 'abstract' . DS . strtolower($className) . '.php');
        }
